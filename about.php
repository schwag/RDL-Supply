                ...
                <div class="container">
                     ...
                     <div class="row">
                        <div class="aboutSection">
                            <div class="col-md-12">
                                <div class="aboutBox">
                                    <h3>About RDL Supply</h3>
                                    <p><span class="glyphicon glyphicon-ok"></span> Lorem ipsum dolor sit amet, an ocurreret maluisset pri. Docendi deserunt ex sed. Quando tollit eu est, congue recteque vis eu. Pro legere graece epicuri ea, no mei corpora consulatu. Odio euismod in eum, quo evertitur ullamcorper id.</p>
